/*
 * Mano robotica con control EMG
 * 
 * Control de una pinza de 3 dedos mediante sensor MyoWare v1
 * y servo de rotacion continua DS04-NFC.
 * 
 * Al arrancar ofrece:
 *   c -> calibrar (5 mediciones reposo + 5 contraccion)
 *   s -> usar valores guardados
 * 
 * Conexiones:
 *   MyoWare SIG -> A0
...
const int TIEMPO_MS       = 1500;  // duracion cierre/apertura
const int ESPERA_CERRADA  = 2000;  // tiempo minimo cerrada
const int LECTURAS_REPOSO = 5;     // lecturas consecutivas para confirmar reposo
const int N_CALIBRACION   = 5;     // mediciones por fase de calibracion
...
void loop() {
  ...
  switch (estado) {
    ...
    case 3:  // espera relajar con tiempo minimo y lecturas consecutivas
